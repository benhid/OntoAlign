...
from owlready2 import EntityClass, entity, get_ontology, owl
...
def get_class_names(cls):
    """
    Get the URI name and english label of the class.
    """
    name = cls.name
...
def append_super_class(cls, p: List[str]) -> List[str]:
    """
    Recursive function.
    """
    p.append(cls.iri)
...
def get_class_path(cls) -> List[str]:
    """
